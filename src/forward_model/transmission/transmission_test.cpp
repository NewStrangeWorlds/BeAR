...
bool TransmissionModel::testModel(const std::vector<double>& parameter, double* model_spectrum_gpu)
{
  bool test_ok = false;
...
bool TransmissionModel::testCPUvsGPU(const std::vector<double>& parameter, double* model_spectrum_gpu)
{ 
