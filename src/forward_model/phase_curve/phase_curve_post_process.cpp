...
PhaseCurvePostProcessConfig::PhaseCurvePostProcessConfig (const std::string& folder_path)
{
...
void PhaseCurveModel::postProcess(
  ...
  bool& delete_unused_files)
{
  PhaseCurvePostProcessConfig post_process_config(config->retrieval_folder_path);
