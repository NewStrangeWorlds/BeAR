...
class DiscreteOrdinates : public RadiativeTransfer{
  public:
    DiscreteOrdinates(Retrieval* retrieval_ptr, const size_t nb_streams, const size_t nb_grid_points);
  ...
  private:
    ...
    double calcSpectrum(const std::vector<double> absorption_coeff, const std::vector<double> scattering_coeff,
