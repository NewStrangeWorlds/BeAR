...
class BeAREmissionModel:
  ...
  def __init__(
      ...
      radiative_transfer_model = "scm",
      radiative_transfer_model_parameters = []) :
    ...
    bear_config.forward_model_type = "emission"
    ...
    self.forward_model = pybear.EmissionModel(
      bear_config, 
      self.spectral_grid, 
      self.nb_grid_points, 
